...
/**
 * Controller for handling booking rejections by a renter (for renter's own vehicles).
 */
@WebServlet("/renter/booking/reject")
public class RenterRejectBookingController extends HttpServlet {

    private final BookingService bookingService = new BookingService();
    private final BookingDAO bookingDAO = new BookingDAO();

    /**
     * Handles POST requests to reject a booking.
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            response.sendRedirect(request.getContextPath() + "/renter/booking?success=Booking+rejected+successfully");
