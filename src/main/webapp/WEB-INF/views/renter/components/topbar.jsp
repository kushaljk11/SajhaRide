...
%>
      ...
      <header class="flex h-16 items-center justify-between gap-4 shadow-[2px_0_8px_rgba(153,27,27,0.18)] bg-white px-5">
        ...
        <div class="flex items-center gap-3">
          ...
          <button id="notificationBtn"
            ...
            onclick="toggleRenterNotifications()"
          >
          ...
          <div id="renterNotificationDropdown" class="hidden absolute right-0 mt-2 w-80 bg-white rounded-md shadow-lg overflow-hidden z-50 border border-gray-200">
            <div class="py-2 px-4 bg-gray-50 border-b border-gray-200 flex justify-between items-center">
              ...
              <button onclick="markRenterNotificationsRead()" class="text-xs text-blue-600 hover:text-blue-800">Mark all as read</button>
            </div>
      ...
      <script>
        ...
        function markRenterNotificationsRead() {
