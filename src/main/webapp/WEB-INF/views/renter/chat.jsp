                ...
                <div class="chat-section">
                    ...
                    <div class="chat-body">
                        <div class="message-row">
                            <div class="message-bubble">Hello! Thanks for choosing my Scorpio for your trip to Pokhara.
                            </div>
                        </div>
                        <div class="message-row self">
                            <div class="message-bubble">Hi Birat, excited for the trip! Is the 4WD fully functional? We
                                might hit some muddy trails near the lake.</div>
                        </div>
                        <div class="message-row">
                            <div class="message-bubble">Absolutely. I just had it serviced yesterday. Tires are also
                                brand new all-terrains. The Scorpio is ready for tomorrow morning!</div>
                        </div>
            ...
            document.addEventListener('DOMContentLoaded', function() {
                ...
                function sendMessage() {
                    ...
                    if(text) {
                        ...
                        messageRow.className = 'message-row self';
                        messageRow.innerHTML = '<div class="message-bubble">' + text + '</div>';
                        ...
                        setTimeout(function() {
                            ...
                            replyRow.innerHTML = '<div class="message-bubble">Thank you for your message. I will check and get back to you shortly!</div>';
